            ...
            <div className={cx('main')}>
                <div className={cx('container', 'b-container')} id="b-container">
                    <form className={cx('form')} id="b-form" method="" action="">
                        ...
                        <Link to='' className={cx('form__link')}>Forgot your password?</Link>
                        <div className={cx('form__button', 'button', 'submit')} onClick={handleSubmit}>SIGN IN</div>
                    </form>
                </div>
                <div className={cx('switch')} id="switch-cnt">
                    ...
                    <div className={cx('switch__container')} id="switch-c2">
                        ...
                        <p className={cx('switch__description', 'description')}>Enter your personal details and start journey with us</p>
                        <Link to='/signup'>
                            <div className={cx('switch__button', 'button', 'switch-btn')}>SIGN UP</div>
                        </Link>
                    </div>
                </div>
            </div>
