            ...
            <div className={cx('main')}>
                <div className={cx('container', 'a-container')} id="a-container">
                    <form className={cx('form')} id="a-form" method="" action="">
                        ...
                        <input className={cx('form__input')} type="text" placeholder="Name"/>
                        <input className={cx('form__input')} type="text" placeholder="Email"/>
                        <input className={cx('form__input')} type="password" placeholder="Password"/>
                        <button className={cx('form__button', 'button', 'submit')}>SIGN UP</button>
                    </form>
                </div>
